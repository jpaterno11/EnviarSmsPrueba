...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, Alert, Linking, TouchableWithoutFeedback, Keyboard, Modal, FlatList } from 'react-native';
import { useState } from 'react';
import countriesData from '../assets/countries.json';

export default function WPP() {
    const [celNum, setCellNum] = useState('');
    const [message, setMessage] = useState('Hola! Este es un mensaje de prueba desde la app');
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Limpiar número para WhatsApp (solo números)
            ...
            if (canOpen) {
                ...
                Alert.alert('Éxito', 'WhatsApp se abrió con el mensaje preparado');
            } else {
                Alert.alert('Error', 'No se puede abrir WhatsApp. Verifique que esté instalado.');
            }
          } catch (error) {
    ...
    <>
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <Text style={styles.title}>Enviar WhatsApp</Text>
